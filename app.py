...
<div class="main-header">
    ...
    <p>Tác giả: Phạm Thu Hạnh - Trường TH Vĩnh Hảo - ĐT: 0945 567 115</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phạm Thu Hạnh - Trường TH Vĩnh Hảo - ĐT: 0945 567 115</div>", unsafe_allow_html=True)
